...
ARENA_QUEUE_SKIRMISH = "Skirmish";
ARENA_QUEUE_TITLE = "Arena Battles";
ARENA_REGISTRAR_TEXT = "To create an arena team, you need to select the team type from the dropdown below and enter a unique arena name.";
ARENA_TEAM_CREATED = "Arena team created successfully!";
ARENA_TEAM_DISBAND = "Disband Team";
ARENA_TEAM_DISBANDED = "Arena team disbanded successfully!";
ARENA_TEAM_DISBAND_CONFIRM = "Are you sure you want to disband this arena team?";
ARENA_TEAM_GAMES = "Games";
ARENA_TEAM_GOLD = "Gold Team Wins";
ARENA_TEAM_GREEN = "Green Team Wins";
ARENA_TEAM_INVITE = "Invite Player";
ARENA_TEAM_INVITED = "Player %s has invited you to join their %s arena team named %s.";
ARENA_TEAM_INVITE_DECLINED = "Player %s has declined your invitation.";
ARENA_TEAM_INVITE_INFO = "Enter the name of the player you want to invite below.";
ARENA_TEAM_INVITE_SENT = "You have invited %s to join your arena team.";
ARENA_TEAM_JOINED = "You have joined the arena team '%s'.";
ARENA_TEAM_KICKED = "You have been kicked from the arena team '%s'.";
ARENA_TEAM_KICK_CONFIRM = "Are you sure you want to kick %s from your arena team?";
ARENA_TEAM_KICK_MEMBER = "Kick Member";
ARENA_TEAM_LEAVE = "Leave Team";
ARENA_TEAM_LEAVE_CONFIRM = "Are you sure you want to leave this arena team?";
ARENA_TEAM_LEFT = "You have left the arena team '%s'.";
ARENA_TEAM_MEMBER_JOINED = "Player %s has joined your arena team.";
ARENA_TEAM_MEMBER_KICKED = "Player %s has been kicked from the arena team.";
ARENA_TEAM_MEMBER_LEFT = "Player %s has left the arena team '%s'.";
...
CHAT_THROTTLED_NOTICE = "[%s] This channel has Slowmode enabled. Please wait to send another message.";
...
CHRONOBOON_LINE_2 = "While a world effect is suspended, you cannot benefit from it.";
...
DONO_SHOP_AUTODRESS = "Auto Preview";
DONO_SHOP_AUTODRESS_TOOLTIP = "Checking this will automatically show selected items on your character or show a creature model if there is one.\n\nYou can also CTRL-Left Click to achieve this.";
DONO_SHOP_BALANCE = "Balance: ";
DONO_SHOP_CHANGE_COLOR = "Change Color";
DONO_SHOP_CHAT_COMMAND = "The minimap shop button is now hidden. To bring it back, type '/shop button'.";
DONO_SHOP_CLAIM = "Claim";
DONO_SHOP_CONFIRM = "Claim [%s] for %d tokens?";
DONO_SHOP_CONFIRM_HIDE = "Are you sure you want to hide the minimap shop button?";
...
DONO_SHOP_TOOLTIP3 = "Holt alt and right-click to hide this button.";
...
GUILD_BANK_ERR_HARDCORE = "Guild Bank is not available for Hardcore players.";
...
HELPFRAME_HOME_ISSUE2 = "Additionally, we kindly ask you to make bug reports through our Bugtracker on our Website! It's easier for the team to document and investigate issues this way.";
...
HELPFRAME_TECHNICAL_BULLET_TITLE2 = "You may find that a solution for your issue has already been posted on turtlecraft.gg/bug-tracker";
...
HELP_LABEL = "Help";
HELP_SHIFT_CLICK_HINT = "Hold down Shift and right-click to use item.";
...
LFT_CHAT_ERROR_ALREADY_IN_TEAM = "Unable to form a party because one or more invited members are already in a group.";
LFT_CHAT_ERROR_HARDCORE = "Group Finder is unavailable for hardcore players.";
LFT_CHAT_ERROR_INTERNAL = "Internal Group Finder error.";
LFT_CHAT_ERROR_INVALID = "Invalid group entry.";
LFT_CHAT_ERROR_IN_GROUP = "You are in a group.";
LFT_CHAT_ERROR_MEMBER_OFFLINE = "A member of your party is offline.";
LFT_CHAT_ERROR_NOT_LEADER = "You are not the party leader.";
LFT_CHAT_ERROR_QUEUE_DISABLED = "Queue disabled.";
LFT_CHAT_ERROR_REQUIREMENTS_LEVEL = "A party member does not meet the level requirements.";
LFT_CHAT_ERROR_REQUIREMENTS_ROLE = "A party member has selected an unsupported role.";
LFT_CHAT_NEW_SIGNUP = "|Hplayer:%s|h[%s]|h has signed up to your group.";
LFT_CHAT_NEW_SIGNUP_ROLES = "|Hplayer:%s|h[%s]|h has signed up to your group as %s.";
LFT_CHAT_OFFER_DECLINED_TEXT = "You have declined the offer. You have been removed from the queue.";
LFT_CHAT_QUEUE_JOIN_TEXT = "You have joined the queue for %s.";
LFT_CHAT_SELECTED_ROLES_TEXT = " has selected these roles: ";
LFT_CONFIRM_ROLE = "Confirmed";
LFT_DELETE_GROUP_CONFIRM_TEXT = "Are you sure you want to delete this group?";
LFT_DELETE_GROUP_CONFIRM_TEXT2 = "This action will delete your group \"%s\" from the list, are you sure you want to continue?";
LFT_DROPDOWN_LABEL_TEXT = "Type:";
LFT_DROPDOWN_TYPE_1 = "Suggested Dungeons";
LFT_DROPDOWN_TYPE_2 = "All Available Dungeons";
LFT_DUNGEON_BFD = "Blackfathom Deeps";
LFT_DUNGEON_BRD = "Blackrock Depths";
LFT_DUNGEON_BRDARENA = "Blackrock Depths Arena";
LFT_DUNGEON_BRDEMP = "Blackrock Depths Emperor";
LFT_DUNGEON_COTBM = "Caverns of Time: Black Morass";
LFT_DUNGEON_DM = "The Deadmines";
LFT_DUNGEON_DME = "Dire Maul East";
LFT_DUNGEON_DMN = "Dire Maul North";
LFT_DUNGEON_DMR = "Dragonmaw Retreat";
LFT_DUNGEON_DMT = "Dire Maul Tribute";
LFT_DUNGEON_DMW = "Dire Maul West";
LFT_DUNGEON_GILNEAS = "Gilneas City";
LFT_DUNGEON_GNOMER = "Gnomeregan";
LFT_DUNGEON_HFC = "Hateforge Quarry";
LFT_DUNGEON_KC = "Karazhan Crypt";
LFT_DUNGEON_LBRS = "Lower Blackrock Spire";
LFT_DUNGEON_MARAORANGE = "Maraudon Orange";
LFT_DUNGEON_MARAPRINCESS = "Maraudon Princess";
LFT_DUNGEON_MARAPURPLE = "Maraudon Purple";
LFT_DUNGEON_RFC = "Ragefire Chasm";
LFT_DUNGEON_RFD = "Razorfen Downs";
LFT_DUNGEON_RFK = "Razorfen Kraul";
LFT_DUNGEON_SCHOLO = "Scholomance";
LFT_DUNGEON_SFK = "Shadowfang Keep";
LFT_DUNGEON_SMARM = "Scarlet Monastery Armory";
LFT_DUNGEON_SMCATH = "Scarlet Monastery Cathedral";
LFT_DUNGEON_SMLIB = "Scarlet Monastery Library";
LFT_DUNGEON_SM_GY = "Scarlet Monastery Graveyard";
LFT_DUNGEON_ST = "Temple of Atal'Hakkar";
LFT_DUNGEON_STOCKS = "The Stockade";
LFT_DUNGEON_STRATLIVE = "Stratholme: Scarlet Bastion";
LFT_DUNGEON_STRATUD = "Stratholme: Undead District";
LFT_DUNGEON_SWC = "Stormwrought Castle";
LFT_DUNGEON_SWD = "Stormwrought Descent";
LFT_DUNGEON_SWV = "Stormwind Vault";
LFT_DUNGEON_TCG = "The Crescent Grove";
LFT_DUNGEON_ULDA = "Uldaman";
LFT_DUNGEON_WC = "Wailing Caverns";
...
LFT_GROUPS_TYPE1 = "Dungeons & Raids";
LFT_GROUPS_TYPE2 = "Quests";
LFT_GROUPS_TYPE3 = "Custom";
LFT_GROUP_READY_COMPLETE_TEXT = "The dungeon group for %s is ready. Enjoy!";
...
LFT_ROLE_DAMAGE_TOOLTIP = "Indicates that you are willing to take on the role of dealing damage to enemies.";
LFT_ROLE_HEALER_TOOLTIP = "Indicates that you are willing to heal your allies when they take damage.";
LFT_ROLE_TANK_TOOLTIP = "Indicates that you are willing to protect allies from harm by ensuring that enemies are attacking you instead of them.";
LFT_SIGNUP = "Sign Up";
LFT_SIGNUP_CANCEL = "Cancel Sign-up";
LFT_SPECIAL_INVITE_TEXT = "%s invites you to a group \"%s\" as %s.";
LFT_SPECIAL_INVITE_TEXT2 = "%s invites you to a group \"%s\".";
LFT_TITLE = "Title";
...
MANAGE_ACCOUNT_URL = "http://www.turtlecraft.gg/";
MANA_COLON = "Mana:";
MANA_COST = "%d Mana";
...
OPTION_TOOLTIP_SHOW_PLAYER_CHALLENGES = "Show active leveling challenges of a player in the player tooltip.";
...
OPTION_TOOLTIP_TRANSMOG_VISIBILITY = "Uncheck this to disable transmog in battlegrounds and arenas, showing the real gear of players.";
...
OPTION_TOOLTIP_USE_REFRESH = "Changes the monitor refresh rates when fullscreen mode is enabled. Higher rates flicker less.";
...
OPTION_TOOLTIP_WINDOWED_MODE = "Check to play in a non-fullscreen window.\n\nIf this is checked the game will use your desktop gamma and refresh rate.";
...
PVP_MEDAL37 = "The AddOns Architect";
PVP_MEDAL38 = "Azeroth's Most Unlucky Tourist";
PVP_MEDAL4 = "High Sentinel of Darnassus";
PVP_MEDAL40 = "The Hambringer";
PVP_MEDAL41 = "Guardian of the Flame";
...
PVP_MEDAL65 = "Godslayer of Hakkar";
PVP_MEDAL66 = "Destroyer of Dreams";
PVP_MEDAL7 = "Avenger of Gnomeregan";
PVP_MEDAL8 = "Voodoo Boss of Sen'jin";
PVP_MEDAL9 = "Bruiser of Sparkwater";
PVP_POLICY_URL = "|cffffd200http://www.turtlecraft.gg/rules|r";
...
SHOW_PLAYER_CHALLENGES_TEXT = "Display Player Challenges";
...
TRANSMOG_AVAILABLE_COINS = "Available Fashion Coins";
TRANSMOG_CHANGED_TO = "Transmogrified to:";
TRANSMOG_FASHION_COIN = "Fashion Coin";
TRANSMOG_FASHION_COINS = "Coin(s)";
TRANSMOG_FASHION_COINS_DESC = "Fashion coins are used as a currency for transmogrification.";
...
TRANSMOG_INSUFICCIENT_COINS = "Not enough coins";
...
WARNING_DO_NOT_DISABLE = "Disabling this option may lead to rendering issues and unexpected game crashes. We recommend leaving this option enabled.\n\nAre you sure you want to disable this option?";
WARNING_DO_NOT_DISABLE2 = "Disabling this option may cause black screen issue. We recommend leaving this option enabled.\n\nAre you sure you want to enable fullscreen mode?";
