...
ACCOUNT_CREATE_URL = "http://www.turtlecraft.gg/register";
...
AUTH_BANNED_URL = "http://www.turtlecraft.gg/rules";
...
AUTH_DB_BUSY_URL = "http://www.turtlecraft.gg/";
...
AUTH_SUSPENDED = "This account has been temporarily suspended for violating the rules: turtlecraft.gg/rules.";
AUTH_SUSPENDED_URL = "http://www.turtlecraft.gg/rules";
AUTH_SYSTEM_ERROR = "System Error";
AUTH_TURTLE_WEBSITE = "http://www.turtlecraft.gg/";
...
BLIZZ_DISCLAIMER = "Mysteries of Azeroth is a fan-made expansion that delves deeper into exploring the original lore of the game.\nWorld of Warcraft remains the intellectual property of Blizzard Entertainment.";
...
CHALLENGES_RESTRICTED = "Not available on PvP realms.";
...
CHALLENGE_BOARING = "Boaring Adventure";
CHALLENGE_BOARING_TEXT = "In this challenge, leveling up is a real pig deal. Experience comes exclusively from slaying boars!";
CHALLENGE_BREWMASTER = "Path of the Brewmaster";
CHALLENGE_BREWMASTER_TEXT = "From bar to the Barrens, your journey begins! You gain no experience unless you're completely smashed. For every ding, have a drink!";
CHALLENGE_CRAFTMASTER = "Traveling Craftmaster";
CHALLENGE_CRAFTMASTER_TEXT = "Equip only what you craft. True power comes from your own hands!";
CHALLENGE_EXHAUSTION = "Exhaustion";
CHALLENGE_EXHAUSTION_TEXT = "No longer gaining rested experience, but your weapon skill gain will be doubled.";
CHALLENGE_HARDCORE = "Hardcore";
CHALLENGE_HARDCORE_TEXT = "Upon death your spirit is lost to the Twisting Nether, unable to ever return to the Material Plane.";
CHALLENGE_LUNATIC = "Level One Lunatic";
CHALLENGE_LUNATIC_TEXT = "During this challenge, you will earn exclusive titles while staying at level one.";
CHALLENGE_SLOW_AND_STEADY = "Slow & Steady";
CHALLENGE_SLOW_AND_STEADY_TEXT = "Gaining 50% fewer experience points from defeating enemies. Lose 5% of accumulated experience from current level upon being defeated by enemies.";
CHALLENGE_VAGRANT = "Vagrant's Endeavor";
CHALLENGE_VAGRANT_TEXT = "You can only use poor and common quality equipment. Enchanting items is not allowed.";
CHALLENGE_WAR_MODE = "War Mode";
CHALLENGE_WAR_MODE_TEXT = "You can no longer disable PvP but experience gain from all sources is increased.";
CHANGE = "Change";
...
COMMUNITY_URL = "http://forum.turtlecraft.gg";
...
LOGIN_BADVERSION = "Unable to validate game version! Please download the game client from our website: turtlecraft.gg";
...
SERVER_ALERT_URL = "http://www.turtlecraft.gg/alert_en1180.html";
...
TECH_SUPPORT_URL = "http://forum.turtlecraft.gg/";
TEMP_ARMOR = "- Cloth\n- Leather\n- Mail";
...
TURTLE_ARMORY_WEBSITE = "http://www.turtlecraft.gg/armory";
TURTLE_COMMUNITY_FORUM = "Community";
TURTLE_COMMUNITY_FORUM_WEBSITE = "http://forum.turtlecraft.gg/";
TURTLE_DISCORD = "Discord";
TURTLE_DISCORD_WEBSITE = "http://www.turtlecraft.gg/discord";
TURTLE_KNOWLEDGE_DATABASE = "Database";
TURTLE_KNOWLEDGE_DATABASE_WEBSITE = "http://database.turtlecraft.gg/";
TURTLE_REDDIT = "Reddit";
TURTLE_REDDIT_WEBSITE = "http://www.turtlecraft.gg/reddit";
